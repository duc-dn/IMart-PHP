                    ...
                    <tbody>
                        <?php if (!empty($list_product)) { foreach($list_product as $item) { ?>
                            <tr>
                                ...
                                <td><?= currency_format(isset($item['promotional_price'])? $price = $item['promotional_price'] * $item['quantity'] : $price = $item['original_price'] * $item['quantity'])?></td>
                                <td>
                                ...
                                <div class="clearfix">
                                    <div class="fl-right">
                                        ...
                                        <a  style="display: inline-block;padding: 12px 25px;text-transform: uppercase;font-size: 13px;border-radius: 3px;font-family: 
                                            'Roboto Bold';font-weight: normal;border: none;outline: none;background: #3f5da6;color: #fff;" 
